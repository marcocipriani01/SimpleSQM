...
public class SerialService extends Service implements SerialListener {
    ...
    private void createNotification() {
        ...
        PendingIntent disconnectPendingIntent = PendingIntent.getBroadcast(this, 1, disconnectIntent, SERVICE_PENDING_INTENT_FLAG);
        PendingIntent restartPendingIntent = PendingIntent.getActivity(this, 1, restartIntent, SERVICE_PENDING_INTENT_FLAG);
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, Constants.NOTIFICATION_CHANNEL)
                ...
                .setOngoing(true)
                .addAction(new NotificationCompat.Action(null, "Disconnect", disconnectPendingIntent));
